 ...
 * </P>
 */
public class APManagerBackup {
    private static APManagerBackup apManager;
    private final Utils utils;

    private APManagerBackup(Context context) {
     ...
     * @return APManager
     */
    public static APManagerBackup getApManager(@NonNull Context context) {
        if (apManager == null) {
            apManager = new APManagerBackup(context);
        }
        return apManager;
    }
                ...
                try {
                    wifiManager.startLocalOnlyHotspot(new WifiManager.LocalOnlyHotspotCallback() {
                        public void onStarted(WifiManager.LocalOnlyHotspotReservation reservation) {
                            ...
                            APManagerBackup.this.reservation = reservation;
                            try {
